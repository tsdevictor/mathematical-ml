...
def backprop(radius, sign):
    ...
    while True:
        ...
        if test_num > 1000 and error_sum < 19: input_lst, training_lst, num_samples = generate_training(radius, sign)
        if time.time() - start > 25: return layer_sizes, weights
...
def generate_training(radius, sign):
    num_samples = 6000
    ...
    return input_lst, training_lst, num_samples
